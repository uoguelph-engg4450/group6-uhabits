...
public class ListHabitsMenuTest extends BaseUnitTest
{
    ...
    public void setUp()
    {
        ...
        when(preferences.getShowSorted()).thenReturn(false);
    ...
    public void testOnCreate()
    {
        ...
        MenuItem showSortedItem = mock(MenuItem.class);
        ...
        when(androidMenu.findItem(R.id.actionHideCompleted)).thenReturn(
            hideCompletedItem);
        when(androidMenu.findItem(R.id.actionSortList)).thenReturn(
                showSortedItem);
        ...
        verify(showSortedItem).setChecked(false);
        reset(nightModeItem, hideArchivedItem, hideCompletedItem, showSortedItem);
