...
public class HabitMatcherBuilder
{
    ...
    private boolean sortedAllowed = true;
    ...
    //correct number of colors are being passed (verified) - Andrew M
    ...
    public HabitMatcherBuilder setSortedAllowed(boolean sortedAllowed)
    {
        this.sortedAllowed = sortedAllowed;
        return this;
    }
